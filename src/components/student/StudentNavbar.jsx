                ...
                <div className="flex items-center gap-2">
                    ...
                    >
                        <div className="text-right">
                            <p className="text-xs font-black text-examsy-text uppercase tracking-tight">{STUDENT_DATA.name}</p>
                            <p className="text-[10px] font-bold text-examsy-muted">{STUDENT_DATA.major}</p>
                        </div>
                        ...
                        <div className="w-10 h-10 rounded-xl bg-examsy-primary/10 flex items-center justify-center text-examsy-primary font-black text-sm overflow-hidden border-2 border-transparent group-hover:border-examsy-primary/30 transition-all">
                            {STUDENT_DATA.profileImage ? (
                                <img
                                    src={STUDENT_DATA.profileImage}
                                    alt="Profile"
