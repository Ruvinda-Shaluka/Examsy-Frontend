        ...
        <div className="fixed inset-0 z-[200] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
            <div className="bg-examsy-surface w-full max-w-md rounded-[32px] border border-zinc-200 dark:border-zinc-800 shadow-2xl animate-in zoom-in-95 duration-200">
                <div className="p-6 border-b border-zinc-100 dark:border-zinc-800 flex justify-between items-center">
                    ...
                    <button onClick={onClose} className="p-2 hover:bg-examsy-bg rounded-xl text-examsy-muted transition-colors"><X size={20}/></button>
                </div>
                    ...
                    <div className="space-y-1.5">
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                className="w-full pl-12 pr-4 bg-examsy-bg border border-zinc-200 dark:border-zinc-800 rounded-2xl py-3.5 outline-none focus:border-examsy-primary text-examsy-text font-bold text-sm"
                                placeholder="https://examsy.com/join/..."
                            />
                        </div>
                        <p className="text-xs text-examsy-muted mt-2 ml-1">Ask your instructor for the class invite link, then enter it here.</p>
                    </div>
