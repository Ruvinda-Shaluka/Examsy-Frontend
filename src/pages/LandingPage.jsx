            ...
            <section className="pt-24 pb-20 px-6">
                <div className="container mx-auto text-center">
                    ...
                    <div className="flex justify-center gap-4">
                        ...
                        <Link to="/register-student"
                              className="px-8 py-3 bg-examsy-surface border border-zinc-200 dark:border-zinc-700 font-bold rounded-lg hover:bg-examsy-surface/80 transition-all">
                            Join a Class
                        </Link>
                    </div>
                </div>
...
const FeatureCard = ({icon, title, desc}) => (
    <div
        className="p-8 bg-examsy-surface rounded-2xl border border-transparent hover:border-examsy-primary/20 hover:shadow-xl transition-all duration-300">
