...
const StudentSettings = () => {
    ...
    const [profile, setProfile] = useState(STUDENT_DATA);
    const [notifs, setNotifs] = useState({ email: true, mobile: true, security: true });
    const fileInputRef = useRef(null);

    // Handle Local Image Upload (Same logic as teacher)
    ...
    const handleSave = () => {
        // Future backend: POST/PATCH profile to /api/student/profile
        alert("Student Profile and Academic Details saved!");
    };
            ...
            <div className="max-w-4xl mx-auto space-y-8 pb-10 animate-fade-in">
                ...
                <section className="bg-examsy-surface rounded-[40px] border border-zinc-200 dark:border-zinc-800 p-10 shadow-sm transition-colors duration-500">
                    <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-6 mb-10">
                        ...
                        <button
                            onClick={handleSave}
                            className="w-full sm:w-auto bg-examsy-primary text-white px-8 py-3.5 rounded-2xl font-black flex items-center justify-center gap-2 shadow-lg hover:scale-[1.02] transition-all"
                        >
                    ...
                    <div className="flex flex-col lg:flex-row gap-12">
                        ...
                        <div className="flex-1 grid grid-cols-1 sm:grid-cols-2 gap-6">
                            ...
                            <div className="space-y-1.5">
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        className="w-full bg-examsy-bg border border-zinc-200 dark:border-zinc-800 rounded-2xl py-3 pl-12 pr-4 font-bold text-examsy-text outline-none focus:border-examsy-primary transition-all"
                                    />
                                </div>
                            </div>
                            ...
                            {/* Major/Field */}
                            <div className="space-y-1.5">
                                <label className="text-[10px] font-black text-examsy-muted uppercase tracking-[0.2em] ml-1">Major / Major</label>
                                <div className="relative">
                            ...
                            <div className="space-y-1.5 sm:col-span-2">
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        value={profile.id}
                                        readOnly
                                        className="w-full bg-examsy-bg/50 border border-zinc-200 dark:border-zinc-800 rounded-2xl py-3 pl-12 pr-4 font-bold text-examsy-muted outline-none cursor-not-allowed"
                                    />
                                </div>
                            </div>
                            ...
                            <div className="space-y-1.5 sm:col-span-2">
                                ...
                                <div className="relative">
                                    ...
                                    <textarea
                                        ...
                                        className="w-full bg-examsy-bg border border-zinc-200 dark:border-zinc-800 rounded-2xl py-4 pl-12 pr-4 font-bold text-examsy-text h-32 resize-none outline-none focus:border-examsy-primary transition-all"
                                    />
                                </div>
                            </div>
                        </div>
                ...
                <section className="bg-examsy-surface rounded-[40px] border border-zinc-200 dark:border-zinc-800 p-10 shadow-sm transition-colors duration-500">
                    ...
                    <div className="space-y-4">
                        {[
                            ...
                            { id: 'mobile', icon: Smartphone, label: 'Push Notifications', desc: 'Alerts for upcoming deadlines and exam reminders.' },
                            { id: 'security', icon: Shield, label: 'Identity Alerts', desc: 'Get notified of proctoring flags or unauthorized logins.' }
                        ].map(item => (
