...
const StudentSettings = () => (<StudentLayout>
        <div className="max-w-4xl mx-auto space-y-12 animate-fade-in">
            <header>
                <h1 className="text-3xl font-black uppercase tracking-tight text-examsy-text">Student Settings</h1>
                <p className="text-examsy-muted font-bold">Manage your profile, identity verification, and
                    notifications.</p>
            </header>
            ...
            <div className="grid gap-8">
                {/* Profile Section */}
                <div
                    className="bg-examsy-surface p-8 rounded-[40px] border border-zinc-200 dark:border-zinc-800 shadow-sm">
                    <div className="flex items-center gap-8 mb-10">
                        <div
                            className="w-24 h-24 rounded-[32px] bg-examsy-primary flex items-center justify-center text-4xl text-white font-black shadow-lg shadow-purple-500/30">
                            {STUDENT_DATA.avatar}
                        </div>
                        <div>
                            ...
                            <button
                                className="mt-4 text-xs font-black text-examsy-primary uppercase tracking-widest hover:underline">Change
                                Photo
                            </button>
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="space-y-2">
                            <label className="text-[10px] font-black uppercase tracking-widest text-examsy-muted ml-4">Full
                                Name</label>
                            <input
                                type="text"
                        ...
                        <div className="space-y-2">
                            <label className="text-[10px] font-black uppercase tracking-widest text-examsy-muted ml-4">Student
                                ID</label>
                            <input
                                type="text"
                                readOnly
                ...
                <div
                    ...
                    <div
                        className="flex items-center justify-between p-6 bg-examsy-bg rounded-2xl border border-zinc-100 dark:border-zinc-800">
